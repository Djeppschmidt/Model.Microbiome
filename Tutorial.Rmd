...
ggplot(C.D500$rep1$model$SpeciesMeta, aes(x=deseqLII,y=deseqOI,col=scaledOI))+geom_point()
ggplot(C.D500$rep1$model$SpeciesMeta, aes(x=scaledLII,y=scaledOI,col=deseqOI))+geom_point()
