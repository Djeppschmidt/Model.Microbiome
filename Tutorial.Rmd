...
C.D500<-benchmark.MM(reps=1, commonN=73, groupN=1, singleN=1, D=500, V=250)
#
...
keep<-names(C.D500$rep1$deseqVST$OI$SVI)[C.D500$rep1$deseqVST$OI$SVI<0]

box.df2<-data.frame("reference"=C.D500$rep1$model$R$lm[names(C.D500$rep1$model$R$lm)%in%keep],"deseqVST"=C.D500$rep1$deseqVST$OI$R$lm[names(C.D500$rep1$deseqVST$OI$R$lm)%in%keep],"limmaVST"=C.D500$rep1$limma$OI$R$lm[names(C.D500$rep1$limma$OI$R$lm)%in%keep],"RA"=C.D500$rep1$RA$OI$R$lm[names(C.D500$rep1$RA$OI$R$lm)%in%keep],"erare"=C.D500$rep1$eRare$OI$R$lm[names(C.D500$rep1$eRare$OI$R$lm)%in%keep],"scaled"=C.D500$rep1$scaled$OI$R$lm[names(C.D500$rep1$scaled$OI$R$lm)%in%keep])
box.df$names<-rownames(box.df)
...
```
```{R}
LII.plotdat<-melt(data=C.D500$rep1$model$SpeciesMeta, id.vars=c("names","prevalence","mean"), measure.vars = c("reference", "RA", "scaled", "erare", "limmaVST", "deseqVST"))

ggplot(C.D500$rep1$model$SpeciesMeta, aes(x=deseqOI,y=scaledOI))+geom_point()
ggplot(C.D500$rep1$model$SpeciesMeta, aes(x=prevalence,y=scaledOI,col=deseqOI))+geom_point()
ggplot(C.D500$rep1$model$SpeciesMeta, aes(x=deseqLII,y=deseqOI,col=prevalence))+geom_point()
ggplot(C.D500$rep1$model$SpeciesMeta, aes(x=deseqLII,y=deseqOI,col=scaledOI))+
  geom_point()+
  scale_color_viridis_c()
ggplot(C.D500$rep1$model$SpeciesMeta, aes(x=scaledLII,y=scaledOI,col=deseqOI))+
  geom_point()+
  scale_color_viridis_c()
ggplot(C.D500$rep1$model$SpeciesMeta, aes(x=rawLII,y=rawOI,col=deseqOI))+
  geom_point()+
  scale_color_viridis_c()
#ggplot(C.D500$rep1$model$SpeciesMeta, aes(x=deseqLII,y=deseqOI,col=sd_abundance))+geom_point()
#ggplot(C.D500$rep1$model$SpeciesMeta, aes(x=deseqLII,y=deseqOI,col=mean_abundance))+geom_point()
```
