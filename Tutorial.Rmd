...
keep<-names(C.D500$rep1$deseqVST$DMI$SVI)[C.D500$rep1$deseqVST$DMI$SVI<0]
...
ggplot(C.D500$rep2$model$SpeciesMeta, aes(x=scaledLII,y=scaledDMI,col=log(M.Eval)))+geom_point()+ scale_color_viridis_c(option="C")
ggplot(C.D500$rep3$model$SpeciesMeta, aes(x=scaledLII,y=scaledDMI,col=log(M.Eval)))+geom_point()+ scale_color_viridis_c(option="C")
ggplot(C.D500$rep4$model$SpeciesMeta, aes(x=scaledLII,y=scaledDMI,col=log(M.Eval)))+geom_point()+ scale_color_viridis_c(option="C")
ggplot(C.D500$rep5$model$SpeciesMeta, aes(x=scaledLII,y=scaledDMI,col=log(M.Eval)))+geom_point()+ scale_color_viridis_c(option="C")

```

```{R}
ggplot(C.D500$rep1$model$SpeciesMeta, aes(x=deseqLII,y=deseqDMI,col=log(M.Eval)))+geom_point()+ scale_color_viridis_c(option="C")
ggplot(C.D500$rep2$model$SpeciesMeta, aes(x=deseqLII,y=deseqDMI,col=log(M.Eval)))+geom_point()+ scale_color_viridis_c(option="C")
ggplot(C.D500$rep3$model$SpeciesMeta, aes(x=deseqLII,y=deseqDMI,col=log(M.Eval)))+geom_point()+ scale_color_viridis_c(option="C")
ggplot(C.D500$rep4$model$SpeciesMeta, aes(x=deseqLII,y=deseqDMI,col=log(M.Eval)))+geom_point()+ scale_color_viridis_c(option="C")
ggplot(C.D500$rep5$model$SpeciesMeta, aes(x=deseqLII,y=deseqDMI,col=log(M.Eval)))+geom_point()+ scale_color_viridis_c(option="C")
