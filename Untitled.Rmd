...
model$QSeq10$PERMANOVA # highest mean value
```
...
#Normalization vs community structure
...
TukeyHSD(aov(SM.lmRatioM.model10.p$value~SM.lmRatioM.model10.p$variable)) # something wrong here?
...
# summarize for plotting
V.TaxRatio.model10.p<-data_summary2(V.TaxRatio.model10Levels, varname="value", groupnames=c("Level", "Var2"))
M.TaxRatio.model10.p<-data_summary2(M.TaxRatio.model10Levels, varname="value", groupnames=c("Level", "Var2"))
# plot
ggplot(V.TaxRatio.model10.p, aes(x=Level, y=log10(value), group = Var2, color=Var2))+
...
ggplot(M.TaxRatio.model10.p, aes(x=Level, y=value, group = Var2, color=Var2))+
  geom_errorbar(aes(ymin=low, ymax=high), width=.1, position=position_dodge(.3)) +
  scale_color_viridis_d(direction=-1)+
  geom_line(position=position_dodge(.3))+
  geom_point(position=position_dodge(.3))+
...
```
In terms of the median, it appears that at all levels of structure, QSeq10 performs the best; that QSeq0.5 is generally not particularly great; and raw count data performs the worst at very unstructured data. In terms of the variance, it looks like all the QSeq outperform raw, but aren't very differentiated among themselves. But let's check the stats:

```{r}
summary(aov(M.TaxRatio.model10.p$value~M.TaxRatio.model10.p$Level*M.TaxRatio.model10.p$Var2))

TukeyHSD(aov(M.TaxRatio.model10.p$value~M.TaxRatio.model10.p$Level*M.TaxRatio.model10.p$Var2))

summary(aov(V.TaxRatio.model10.p$value~V.TaxRatio.model10.p$Level*V.TaxRatio.model10.p$Var2))

TukeyHSD(aov(V.TaxRatio.model10.p$value~V.TaxRatio.model10.p$Level*V.TaxRatio.model10.p$Var2))
...
model10A_ptab<-Summarize.Ptable(model10.A,method2)
model10B_ptab<-Summarize.Ptable(model10.B,method2)
model10C_ptab<-Summarize.Ptable(model10.C,method2)
model10D_ptab<-Summarize.Ptable(model10.D,method2)

ext.p<-function(x, level, method){
  a<-as.data.frame(x)
  a$Level<-c(rep(level, 10))
  b<-melt(a, id.vars = "Level", measure.vars = method)
  b
}
model10A.Permanova.model<-Summarize.PERMANOVA.Rratio(model10A_ptab$model, method2, )

model10A.Permanova.model<-Summarize.PERMANOVA.Rratio(model10.A,method2, "CategoryRratio")
model10A.Permanova.env1<-Summarize.PERMANOVA.Rratio(model10.A, method2, "F1Rratio")
model10A.Permanova.env2<-Summarize.PERMANOVA.Rratio(model10.A, method2, "F2Rratio")
model10A.Permanova.env3<-Summarize.PERMANOVA.Rratio(model10.A, method2, "F3Rratio")
model10A.Permanova.env4<-Summarize.PERMANOVA.Rratio(model10.A, method2, "F4Rratio")
model10A.Permanova.env5<-Summarize.PERMANOVA.Rratio(model10.A,method2, "F5Rratio")


model10B.Permanova.model<-Summarize.PERMANOVA.Rratio(model10.B, method2, "CategoryRratio")
model10B.Permanova.env1<-Summarize.PERMANOVA.Rratio(model10.B, method2, "F1Rratio")
model10B.Permanova.env2<-Summarize.PERMANOVA.Rratio(model10.B, method2, "F2Rratio")
model10B.Permanova.env3<-Summarize.PERMANOVA.Rratio(model10.B, method2, "F3Rratio")
model10B.Permanova.env4<-Summarize.PERMANOVA.Rratio(model10.B, method2, "F4Rratio")
model10B.Permanova.env5<-Summarize.PERMANOVA.Rratio(model10.B, method2, "F5Rratio")


model10C.Permanova.model<-Summarize.PERMANOVA.Rratio(model10.C, method2, "CategoryRratio")
model10C.Permanova.env1<-Summarize.PERMANOVA.Rratio(model10.C, method2, "F1Rratio")
model10C.Permanova.env2<-Summarize.PERMANOVA.Rratio(model10.C, method2, "F2Rratio")
model10C.Permanova.env3<-Summarize.PERMANOVA.Rratio(model10.C, method2, "F3Rratio")
model10C.Permanova.env4<-Summarize.PERMANOVA.Rratio(model10.C, method2, "F4Rratio")
model10C.Permanova.env5<-Summarize.PERMANOVA.Rratio(model10.C, method2, "F5Rratio")


model10D.Permanova.model<-Summarize.PERMANOVA.Rratio(model10.D, method2, "CategoryRratio")
model10D.Permanova.env1<-Summarize.PERMANOVA.Rratio(model10.D, method2, "F1Rratio")
model10D.Permanova.env2<-Summarize.PERMANOVA.Rratio(model10.D, method2, "F2Rratio")
model10D.Permanova.env3<-Summarize.PERMANOVA.Rratio(model10.D, method2, "F3Rratio")
model10D.Permanova.env4<-Summarize.PERMANOVA.Rratio(model10.D, method2, "F4Rratio")
model10D.Permanova.env5<-Summarize.PERMANOVA.Rratio(model10.D, method2, "F5Rratio")
...
permanova.model10Levels.resids<-do.call("rbind", list(model10A.Permanova.resids,model10B.Permanova.resids,model10C.Permanova.resids,model10D.Permanova.resids))
...
permanova.model10Levels.residsP<-data_summary2(permanova.model10Levels.resids, varname="value", groupnames=c("Level", "variable"))
...
ggplot(permanova.model10Levels.residsP, aes(x=Level, y=value, group = variable, color=variable))+
  geom_errorbar(aes(ymin=low, ymax=high), width=.1, position=position_dodge(.3)) +
  scale_colour_viridis_d(direction=-1)+
  geom_line(position=position_dodge(.3))+
  geom_point(position=position_dodge(.3))+
  xlab("Degree of Structure")+
  ylab("Permanova residsRatio (Median +/- min/max)")+
  theme_classic()
```



# Normalization vs Sequencing Depth
...
# summarize for plotting
model10.SeqLevels.summary<-data_summary2(model10.SeqLevels, varname="value", groupnames=c("Level", "variable"))
...
SM.lmRatio.model10.C1$Level<-c(rep(1,10))
SV.lmRatio.model10.C1$Level<-c(rep(1,10))
SM.lmRatio.model10.C2$Level<-c(rep(2,10))
SV.lmRatio.model10.C2$Level<-c(rep(2,10))
SM.lmRatio.model10.C3$Level<-c(rep(3,10))
SV.lmRatio.model10.C3$Level<-c(rep(3,10))
SM.lmRatio.model10.C4$Level<-c(rep(4,10))
SV.lmRatio.model10.C4$Level<-c(rep(4,10))
SM.lmRatio.model10.C5$Level<-c(rep(5,10))
SV.lmRatio.model10.C5$Level<-c(rep(5,10))

SM.lmRatio.model10.C1<-melt(SM.lmRatio.model10.C1, id.vars = "Level", measure.vars = method)
SV.lmRatio.model10.C1<-melt(SV.lmRatio.model10.C1, id.vars = "Level", measure.vars = method)
SM.lmRatio.model10.C2<-melt(SM.lmRatio.model10.C2, id.vars = "Level", measure.vars = method)
SV.lmRatio.model10.C2<-melt(SV.lmRatio.model10.C2, id.vars = "Level", measure.vars = method)
SM.lmRatio.model10.C3<-melt(SM.lmRatio.model10.C3, id.vars = "Level", measure.vars = method)
SV.lmRatio.model10.C3<-melt(SV.lmRatio.model10.C3, id.vars = "Level", measure.vars = method)
SM.lmRatio.model10.C4<-melt(SM.lmRatio.model10.C4, id.vars = "Level", measure.vars = method)
SV.lmRatio.model10.C4<-melt(SV.lmRatio.model10.C4, id.vars = "Level", measure.vars = method)
SM.lmRatio.model10.C5<-melt(SM.lmRatio.model10.C5, id.vars = "Level", measure.vars = method)
SV.lmRatio.model10.C5<-melt(SV.lmRatio.model10.C5, id.vars = "Level", measure.vars = method)
...
# summarize for plotting
SM.lmRatio.model10C.p<-data_summary2(SM.lmRatio.model10.CLevels, varname="value", groupnames=c("Level", "variable"))
SV.lmRatio.model10C.p<-data_summary2(SV.lmRatio.model10.CLevels, varname="value", groupnames=c("Level", "variable"))
# plot
...
... and run statistics to see the effect:
```{r}
summary(aov(SM.lmRatio.model10C.p$value~SM.lmRatio.model10C.p$Level*SM.lmRatio.model10C.p$variable))

TukeyHSD(aov(SM.lmRatio.model10C.p$value~SM.lmRatio.model10C.p$Level*SM.lmRatio.model10C.p$variable))

summary(aov(SV.lmRatio.model10C.p$value~SV.lmRatio.model10C.p$Level*SV.lmRatio.model10C.p$variable))

TukeyHSD(aov(SV.lmRatio.model10C.p$value~SV.lmRatio.model10C.p$Level*SV.lmRatio.model10C.p$variable))

leveneTest(value~Level*variable, data=SV.lmRatio.model10C.p)
```

And same steps but for the categorical variables:
```{r}
# lm ratio model sequencing depth ####
SM.lmRatioM.model10.C1<-as.data.frame(Summarize.lmRatiotabModel.Median(model10.C1,method))
SV.lmRatioM.model10.C1<-as.data.frame(Summarize.lmRatiotabModel.Var(model10.C1,method))
SM.lmRatioM.model10.C2<-as.data.frame(Summarize.lmRatiotabModel.Median(model10.C2,method))
SV.lmRatioM.model10.C2<-as.data.frame(Summarize.lmRatiotabModel.Var(model10.C2,method))
SM.lmRatioM.model10.C3<-as.data.frame(Summarize.lmRatiotabModel.Median(model10.C3,method))
SV.lmRatioM.model10.C3<-as.data.frame(Summarize.lmRatiotabModel.Var(model10.C3,method))
SM.lmRatioM.model10.C4<-as.data.frame(Summarize.lmRatiotabModel.Median(model10.C4,method))
SV.lmRatioM.model10.C4<-as.data.frame(Summarize.lmRatiotabModel.Var(model10.C4,method))
SM.lmRatioM.model10.C5<-as.data.frame(Summarize.lmRatiotabModel.Median(model10.C5,method))
SV.lmRatioM.model10.C5<-as.data.frame(Summarize.lmRatiotabModel.Var(model10.C5,method))
# prepare data for merging datasets

SM.lmRatioM.model10.C1$Level<-c(rep(50,10))
SV.lmRatioM.model10.C1$Level<-c(rep(50,10))
SM.lmRatioM.model10.C2$Level<-c(rep(100,10))
SV.lmRatioM.model10.C2$Level<-c(rep(100,10))
SM.lmRatioM.model10.C3$Level<-c(rep(200,10))
SV.lmRatioM.model10.C3$Level<-c(rep(200,10))
SM.lmRatioM.model10.C4$Level<-c(rep(500,10))
SV.lmRatioM.model10.C4$Level<-c(rep(500,10))
SM.lmRatioM.model10.C5$Level<-c(rep(1000,10))
SV.lmRatioM.model10.C5$Level<-c(rep(1000,10))

SM.lmRatioM.model10.C1<-melt(SM.lmRatioM.model10.C1, id.vars = "Level", measure.vars = method)
SV.lmRatioM.model10.C1<-melt(SV.lmRatioM.model10.C1, id.vars = "Level", measure.vars = method)
SM.lmRatioM.model10.C2<-melt(SM.lmRatioM.model10.C2, id.vars = "Level", measure.vars = method)
SV.lmRatioM.model10.C2<-melt(SV.lmRatioM.model10.C2, id.vars = "Level", measure.vars = method)
SM.lmRatioM.model10.C3<-melt(SM.lmRatioM.model10.C3, id.vars = "Level", measure.vars = method)
SV.lmRatioM.model10.C3<-melt(SV.lmRatioM.model10.C3, id.vars = "Level", measure.vars = method)
SM.lmRatioM.model10.C4<-melt(SM.lmRatioM.model10.C4, id.vars = "Level", measure.vars = method)
SV.lmRatioM.model10.C4<-melt(SV.lmRatioM.model10.C4, id.vars = "Level", measure.vars = method)
SM.lmRatioM.model10.C5<-melt(SM.lmRatioM.model10.C5, id.vars = "Level", measure.vars = method)
SV.lmRatioM.model10.C5<-melt(SV.lmRatioM.model10.C5, id.vars = "Level", measure.vars = method)
...
# summarize for plotting
SM.lmRatioM.model10C.p<-data_summary2(SM.lmRatioM.model10CLevels, varname="value", groupnames=c("Level", "variable"))
SV.lmRatioM.model10C.p<-data_summary2(SV.lmRatioM.model10CLevels, varname="value", groupnames=c("Level", "variable"))
# plot
...
ggplot(SV.lmRatioM.model10C.p, aes(x=Level, y=log(value), group = variable, color=variable))+
...
```{r}
summary(aov(SM.lmRatioM.model10C.p$value~SM.lmRatioM.model10C.p$Level*SM.lmRatioM.model10C.p$variable))

TukeyHSD(aov(SM.lmRatioM.model10C.p$value~SM.lmRatioM.model10C.p$Level*SM.lmRatioM.model10C.p$variable))

summary(aov(SV.lmRatioM.model10C.p$value~SV.lmRatioM.model10C.p$Level*SV.lmRatioM.model10C.p$variable))

TukeyHSD(aov(SV.lmRatioM.model10C.p$value~SV.lmRatioM.model10C.p$Level*SV.lmRatioM.model10C.p$variable))

```

Sequencing Depth:
```{r}
TaxRatio.model10.C1<-getTaxCor.Tab(model10.C1,method3)
TaxRatio.model10.C2<-getTaxCor.Tab(model10.C2,method3)
TaxRatio.model10.C3<-getTaxCor.Tab(model10.C3,method3)
TaxRatio.model10.C4<-getTaxCor.Tab(model10.C4,method3)
TaxRatio.model10.C5<-getTaxCor.Tab(model10.C5,method3)
...
# summarize for plotting
V.TaxRatio.model10.Seq.p<-data_summary2(V.TaxRatio.model10Levels, varname="value", groupnames=c("Level", "Var2"))
M.TaxRatio.model10.Seq.p<-data_summary2(M.TaxRatio.model10Levels, varname="value", groupnames=c("Level", "Var2"))
# plot
ggplot(V.TaxRatio.model10.Seq.p, aes(x=Level, y=log10(value), group = Var2, color=Var2))+
...
```{r}
summary(aov(M.TaxRatio.model10.Seq.p$value~M.TaxRatio.model10.Seq.p$Level*M.TaxRatio.model10.Seq.p$Var2))

TukeyHSD(aov(M.TaxRatio.model10.Seq.p$value~M.TaxRatio.model10.Seq.p$Level*M.TaxRatio.model10.Seq.p$Var2))

summary(aov(V.TaxRatio.model10.Seq.p$value~V.TaxRatio.model10.Seq.p$Level*V.TaxRatio.model10.Seq.p$Var2))

TukeyHSD(aov(V.TaxRatio.model10.Seq.p$value~V.TaxRatio.model10.Seq.p$Level*V.TaxRatio.model10.Seq.p$Var2))
```

```{r}
# get permanova sequencing depth ####
model10C1_ptab<-Summarize.Ptable(model10.C1,method2)
model10C2_ptab<-Summarize.Ptable(model10.C2,method2)
model10C3_ptab<-Summarize.Ptable(model10.C3,method2)
model10C4_ptab<-Summarize.Ptable(model10.C4,method2)
model10C5_ptab<-Summarize.Ptable(model10.C5,method2) # come back to check why didn't work

model10C1.Permanova.model<-ext.p(model10C1_ptab$model, 100, method2)
model10C1.Permanova.env1<-ext.p(model10C1_ptab$env1, 100, method2)
model10C1.Permanova.env2<-ext.p(model10C1_ptab$env2, 100, method2)
model10C1.Permanova.env3<-ext.p(model10C1_ptab$env3, 100, method2)
model10C1.Permanova.env4<-ext.p(model10C1_ptab$env4, 100, method2)
model10C1.Permanova.env5<-ext.p(model10C1_ptab$env5, 100, method2)
model10C1.Permanova.resids<-ext.p(model10C1_ptab$resids, 100, method2)

model10C2.Permanova.model<-ext.p(model10C2_ptab$model, 200, method2)
model10C2.Permanova.env1<-ext.p(model10C2_ptab$env1, 200, method2)
model10C2.Permanova.env2<-ext.p(model10C2_ptab$env2, 200, method2)
model10C2.Permanova.env3<-ext.p(model10C2_ptab$env3, 200, method2)
model10C2.Permanova.env4<-ext.p(model10C2_ptab$env4, 200, method2)
model10C2.Permanova.env5<-ext.p(model10C2_ptab$env5, 200, method2)
model10C2.Permanova.resids<-ext.p(model10C2_ptab$resids, 200, method2)

model10C3.Permanova.model<-ext.p(model10C3_ptab$model, 500, method2)
model10C3.Permanova.env1<-ext.p(model10C3_ptab$env1, 500, method2)
model10C3.Permanova.env2<-ext.p(model10C3_ptab$env2, 500, method2)
model10C3.Permanova.env3<-ext.p(model10C3_ptab$env3, 500, method2)
model10C3.Permanova.env4<-ext.p(model10C3_ptab$env4, 500, method2)
model10C3.Permanova.env5<-ext.p(model10C3_ptab$env5, 500, method2)
model10C3.Permanova.resids<-ext.p(model10C3_ptab$resids, 500, method2)

model10C4.Permanova.model<-ext.p(model10C4_ptab$model, 1000, method2)
model10C4.Permanova.env1<-ext.p(model10C4_ptab$env1, 1000, method2)
model10C4.Permanova.env2<-ext.p(model10C4_ptab$env2, 1000, method2)
model10C4.Permanova.env3<-ext.p(model10C4_ptab$env3, 1000, method2)
model10C4.Permanova.env4<-ext.p(model10C4_ptab$env4, 1000, method2)
model10C4.Permanova.env5<-ext.p(model10C4_ptab$env5, 1000, method2)
model10C4.Permanova.resids<-ext.p(model10C4_ptab$resids, 1000, method2)

model10C5.Permanova.model<-ext.p(model10C5_ptab$model, 2000, method2)
model10C5.Permanova.env1<-ext.p(model10C5_ptab$env1, 2000, method2)
model10C5.Permanova.env2<-ext.p(model10C5_ptab$env2, 2000, method2)
model10C5.Permanova.env3<-ext.p(model10C5_ptab$env3, 2000, method2)
model10C5.Permanova.env4<-ext.p(model10C5_ptab$env4, 2000, method2)
model10C5.Permanova.env5<-ext.p(model10C5_ptab$env5, 2000, method2)
model10C5.Permanova.resids<-ext.p(model10C5_ptab$resids, 2000, method2)


permanova.seq10Levels.model<-do.call("rbind", list(model10C1.Permanova.model,model10C2.Permanova.model,model10C3.Permanova.model,model10C4.Permanova.model,model10C4.Permanova.model))
permanova.seq10Levels.env1<-do.call("rbind", list(model10C1.Permanova.env1,model10C2.Permanova.env1,model10C3.Permanova.env1,model10C4.Permanova.env1,model10C4.Permanova.env1))
permanova.seq10Levels.env2<-do.call("rbind", list(model10C1.Permanova.env2,model10C2.Permanova.env2,model10C3.Permanova.env2,model10C4.Permanova.env2,model10C5.Permanova.env2))
permanova.seq10Levels.env3<-do.call("rbind", list(model10C1.Permanova.env3,model10C2.Permanova.env3,model10C3.Permanova.env3,model10C4.Permanova.env3,model10C5.Permanova.env3))
permanova.seq10Levels.env4<-do.call("rbind", list(model10C1.Permanova.env4,model10C2.Permanova.env4,model10C3.Permanova.env4,model10C4.Permanova.env4,model10C5.Permanova.env4))
permanova.seq10Levels.env5<-do.call("rbind", list(model10C1.Permanova.env5,model10C2.Permanova.env5,model10C3.Permanova.env5,model10C4.Permanova.env5,model10C5.Permanova.env5))
permanova.seq10Levels.resids<-do.call("rbind", list(model10C1.Permanova.resids,model10C2.Permanova.resids,model10C3.Permanova.resids,model10C4.Permanova.resids,model10C5.Permanova.resids))

permanova.seq10Levels.modelP<-data_summary2(permanova.seq10Levels.model, varname="value", groupnames=c("Level", "variable"))
permanova.seq10Levels.env1P<-data_summary2(permanova.seq10Levels.env1, varname="value", groupnames=c("Level", "variable"))
permanova.seq10Levels.env2P<-data_summary2(permanova.seq10Levels.env2, varname="value", groupnames=c("Level", "variable"))
permanova.seq10Levels.env3P<-data_summary2(permanova.seq10Levels.env3, varname="value", groupnames=c("Level", "variable"))
permanova.seq10Levels.env4P<-data_summary2(permanova.seq10Levels.env4, varname="value", groupnames=c("Level", "variable"))
permanova.seq10Levels.env5P<-data_summary2(permanova.seq10Levels.env5, varname="value", groupnames=c("Level", "variable"))
permanova.seq10Levels.residsP<-data_summary2(permanova.seq10Levels.resids, varname="value", groupnames=c("Level", "variable"))

ggplot(permanova.seq10Levels.modelP, aes(x=Level, y=value, group = variable, color=variable))+
  geom_errorbar(aes(ymin=low, ymax=high), width=.1, position=position_dodge(.3)) +
  scale_colour_viridis_d(direction=-1)+
  geom_line(position=position_dodge(.3))+
  geom_point(position=position_dodge(.3))+
...
ggplot(permanova.seq10Levels.env1P, aes(x=Level, y=value, group = variable, color=variable))+
  geom_errorbar(aes(ymin=low, ymax=high), width=.1, position=position_dodge(.3)) +
  scale_colour_viridis_d(direction=-1)+
  geom_line(position=position_dodge(.3))+
  geom_point(position=position_dodge(.3))+
...
ggplot(permanova.seq10Levels.env2P, aes(x=Level, y=value, group = variable, color=variable))+
  geom_errorbar(aes(ymin=low, ymax=high), width=.1, position=position_dodge(.3)) +
  scale_colour_viridis_d(direction=-1)+
  geom_line(position=position_dodge(.3))+
  geom_point(position=position_dodge(.3))+
...
ggplot(permanova.seq10Levels.env3P, aes(x=Level, y=value, group = variable, color=variable))+
  geom_errorbar(aes(ymin=low, ymax=high), width=.1, position=position_dodge(.3)) +
  scale_colour_viridis_d(direction=-1)+
  geom_line(position=position_dodge(.3))+
  geom_point(position=position_dodge(.3))+
...
ggplot(permanova.seq10Levels.env4P, aes(x=Level, y=value, group = variable, color=variable))+
  geom_errorbar(aes(ymin=low, ymax=high), width=.1, position=position_dodge(.3)) +
  scale_colour_viridis_d(direction=-1)+
  geom_line(position=position_dodge(.3))+
  geom_point(position=position_dodge(.3))+
...
ggplot(permanova.seq10Levels.env5P, aes(x=Level, y=value, group = variable, color=variable))+
  geom_errorbar(aes(ymin=low, ymax=high), width=.1, position=position_dodge(.3)) +
  scale_colour_viridis_d(direction=-1)+
  geom_line(position=position_dodge(.3))+
  geom_point(position=position_dodge(.3))+
...
ggplot(permanova.seq10Levels.residsP, aes(x=Level, y=value, group = variable, color=variable))+
  geom_errorbar(aes(ymin=low, ymax=high), width=.1, position=position_dodge(.3)) +
  scale_colour_viridis_d(direction=-1)+
  geom_line(position=position_dodge(.3))+
  geom_point(position=position_dodge(.3))+
...
# normalization vs sequencing variance
...
SummaryLII.model10.C1V1<-as.data.frame(Summarize.LII(model10.C1V1, method2))
...
# summarize for plotting
model10.SeqVarLevels.summary<-data_summary2(model10.SeqVarLevels, varname="value", groupnames=c("Level", "variable"))
...
# summarize for plotting
SM.lmRatio.model10CV.p<-data_summary2(SM.lmRatio.model10.CVLevels, varname="value", groupnames=c("Level", "variable"))
SV.lmRatio.model10CV.p<-data_summary2(SV.lmRatio.model10.CVLevels, varname="value", groupnames=c("Level", "variable"))
# plot
...
# summarize for plotting
SM.lmRatio.model10MCV.p<-data_summary2(SM.lmRatio.model10.MCVLevels, varname="value", groupnames=c("Level", "variable"))
SV.lmRatio.model10MCV.p<-data_summary2(SV.lmRatio.model10.MCVLevels, varname="value", groupnames=c("Level", "variable"))
# plot
...
TaxRatio.model10.C1V1<-getTaxCor.Tab(model10.C1V1,method3)
TaxRatio.model10.C1V2<-getTaxCor.Tab(model10.C1V2,method3)
TaxRatio.model10.C1V3<-getTaxCor.Tab(model10.C1V3,method3)
TaxRatio.model10.C1V4<-getTaxCor.Tab(model10.C1V4,method3)
TaxRatio.model10.C1V5<-getTaxCor.Tab(model10.C1V5,method3)
...
# summarize for plotting
V.TaxRatio.model10.SeqV.p<-data_summary2(V.TaxRatio.model10VLevels, varname="value", groupnames=c("Level", "Var2"))
M.TaxRatio.model10.SeqV.p<-data_summary2(M.TaxRatio.model10VLevels, varname="value", groupnames=c("Level", "Var2"))
# plot
ggplot(V.TaxRatio.model10.SeqV.p, aes(x=Level, y=log10(value), group = Var2, color=Var2))+
  geom_errorbar(aes(ymin=log10(low), ymax=log10(high)), width=.1, position=position_dodge(0.1)) +
  scale_color_viridis_d(direction=-1)+
...
model10C1V1_ptab<-Summarize.Ptable(model10.C1V1,method2)
model10C1V2_ptab<-Summarize.Ptable(model10.C1V2,method2)
model10C1V3_ptab<-Summarize.Ptable(model10.C1V3,method2)
model10C1V4_ptab<-Summarize.Ptable(model10.C1V4,method2)
model10C1V5_ptab<-Summarize.Ptable(model10.C1V5,method2) 

model10C1V1.Permanova.model<-ext.p(model10C1V1_ptab$model, 0.1, method2)
model10C1V1.Permanova.env1<-ext.p(model10C1V1_ptab$env1, 0.1, method2)
model10C1V1.Permanova.env2<-ext.p(model10C1V1_ptab$env2, 0.1, method2)
model10C1V1.Permanova.env3<-ext.p(model10C1V1_ptab$env3, 0.1, method2)
model10C1V1.Permanova.env4<-ext.p(model10C1V1_ptab$env4, 0.1, method2)
model10C1V1.Permanova.env5<-ext.p(model10C1V1_ptab$env5, 0.1, method2)
model10C1V1.Permanova.resids<-ext.p(model10C1V1_ptab$resids, 0.1, method2)

model10C1V2.Permanova.model<-ext.p(model10C1V2_ptab$model, 0.2, method2)
model10C1V2.Permanova.env1<-ext.p(model10C1V2_ptab$env1, 0.2, method2)
model10C1V2.Permanova.env2<-ext.p(model10C1V2_ptab$env2, 0.2, method2)
model10C1V2.Permanova.env3<-ext.p(model10C1V2_ptab$env3, 0.2, method2)
model10C1V2.Permanova.env4<-ext.p(model10C1V2_ptab$env4, 0.2, method2)
model10C1V2.Permanova.env5<-ext.p(model10C1V2_ptab$env5, 0.2, method2)
model10C1V2.Permanova.resids<-ext.p(model10C1V2_ptab$resids, 0.2, method2)

model10C1V3.Permanova.model<-ext.p(model10C1V3_ptab$model, 0.5, method2)
model10C1V3.Permanova.env1<-ext.p(model10C1V3_ptab$env1, 0.5, method2)
model10C1V3.Permanova.env2<-ext.p(model10C1V3_ptab$env2, 0.5, method2)
model10C1V3.Permanova.env3<-ext.p(model10C1V3_ptab$env3, 0.5, method2)
model10C1V3.Permanova.env4<-ext.p(model10C1V3_ptab$env4, 0.5, method2)
model10C1V3.Permanova.env5<-ext.p(model10C1V3_ptab$env5, 0.5, method2)
model10C1V3.Permanova.resids<-ext.p(model10C1V3_ptab$resids, 0.5, method2)

model10C1V4.Permanova.model<-ext.p(model10C1V4_ptab$model, 1, method2)
model10C1V4.Permanova.env1<-ext.p(model10C1V4_ptab$env1, 1, method2)
model10C1V4.Permanova.env2<-ext.p(model10C1V4_ptab$env2, 1, method2)
model10C1V4.Permanova.env3<-ext.p(model10C1V4_ptab$env3, 1, method2)
model10C1V4.Permanova.env4<-ext.p(model10C1V4_ptab$env4, 1, method2)
model10C1V4.Permanova.env5<-ext.p(model10C1V4_ptab$env5, 1, method2)
model10C1V4.Permanova.resids<-ext.p(model10C1V4_ptab$resids, 1, method2)

model10C1V5.Permanova.model<-ext.p(model10C1V5_ptab$model, 2, method2)
model10C1V5.Permanova.env1<-ext.p(model10C1V5_ptab$env1, 2, method2)
model10C1V5.Permanova.env2<-ext.p(model10C1V5_ptab$env2, 2, method2)
model10C1V5.Permanova.env3<-ext.p(model10C1V5_ptab$env3, 2, method2)
model10C1V5.Permanova.env4<-ext.p(model10C1V5_ptab$env4, 2, method2)
model10C1V5.Permanova.env5<-ext.p(model10C1V5_ptab$env5, 2, method2)
model10C1V5.Permanova.resids<-ext.p(model10C1V5_ptab$resids, 2, method2)


permanova.seq10VLevels.model<-do.call("rbind", list(model10C1V1.Permanova.model,model10C1V2.Permanova.model,model10C1V3.Permanova.model,model10C1V4.Permanova.model,model10C1V4.Permanova.model,model10C1V5.Permanova.model))
permanova.seq10VLevels.env1<-do.call("rbind", list(model10C1V1.Permanova.env1,model10C1V2.Permanova.env1,model10C1V3.Permanova.env1,model10C1V4.Permanova.env1,model10C1V4.Permanova.env1,model10C1V5.Permanova.env1))
permanova.seq10VLevels.env2<-do.call("rbind", list(model10C1V1.Permanova.env2,model10C1V2.Permanova.env2,model10C1V3.Permanova.env2,model10C1V4.Permanova.env2,model10C1V5.Permanova.env2,model10C1V5.Permanova.env2))
permanova.seq10VLevels.env3<-do.call("rbind", list(model10C1V1.Permanova.env3,model10C1V2.Permanova.env3,model10C1V3.Permanova.env3,model10C1V4.Permanova.env3,model10C1V5.Permanova.env3,model10C1V5.Permanova.env3))
permanova.seq10VLevels.env4<-do.call("rbind", list(model10C1V1.Permanova.env4,model10C1V2.Permanova.env4,model10C1V3.Permanova.env4,model10C1V4.Permanova.env4,model10C1V5.Permanova.env4,model10C1V5.Permanova.env4))
permanova.seq10VLevels.env5<-do.call("rbind", list(model10C1V1.Permanova.env5,model10C1V2.Permanova.env5,model10C1V3.Permanova.env5,model10C1V4.Permanova.env5,model10C1V5.Permanova.env5,model10C1V5.Permanova.env5))
permanova.seq10VLevels.resids<-do.call("rbind", list(model10C1V1.Permanova.resids,model10C1V2.Permanova.resids,model10C1V3.Permanova.resids,model10C1V4.Permanova.resids,model10C1V5.Permanova.resids, model10C1V5.Permanova.resids))

permanova.seq10VLevels.modelP<-data_summary2(permanova.seq10VLevels.model, varname="value", groupnames=c("Level", "variable"))
permanova.seq10VLevels.env1P<-data_summary2(permanova.seq10VLevels.env1, varname="value", groupnames=c("Level", "variable"))
permanova.seq10VLevels.env2P<-data_summary2(permanova.seq10VLevels.env2, varname="value", groupnames=c("Level", "variable"))
permanova.seq10VLevels.env3P<-data_summary2(permanova.seq10VLevels.env3, varname="value", groupnames=c("Level", "variable"))
permanova.seq10VLevels.env4P<-data_summary2(permanova.seq10VLevels.env4, varname="value", groupnames=c("Level", "variable"))
permanova.seq10VLevels.env5P<-data_summary2(permanova.seq10VLevels.env5, varname="value", groupnames=c("Level", "variable"))
permanova.seq10VLevels.residsP<-data_summary2(permanova.seq10VLevels.resids, varname="value", groupnames=c("Level", "variable"))

ggplot(permanova.seq10VLevels.modelP, aes(x=Level, y=value, group = variable, color=variable))+
  geom_errorbar(aes(ymin=low, ymax=high), width=.1, position=position_dodge(.03)) +
  scale_colour_viridis_d(direction=-1)+
  geom_line(position=position_dodge(.03))+
  geom_point(position=position_dodge(.03))+
  xlab("Sequencing Relative Variance")+
  ylab("Permanova modelRatio (Median +/- min/max)")+
  theme_classic()

ggplot(permanova.seq10VLevels.env1P, aes(x=Level, y=value, group = variable, color=variable))+
  geom_errorbar(aes(ymin=low, ymax=high), width=.1, position=position_dodge(.03)) +
  scale_colour_viridis_d(direction=-1)+
  geom_line(position=position_dodge(.03))+
  geom_point(position=position_dodge(.03))+
...
ggplot(permanova.seq10VLevels.env2P, aes(x=Level, y=value, group = variable, color=variable))+
  geom_errorbar(aes(ymin=low, ymax=high), width=.1, position=position_dodge(.03)) +
  scale_colour_viridis_d(direction=-1)+
  geom_line(position=position_dodge(.03))+
  geom_point(position=position_dodge(.03))+
...
ggplot(permanova.seq10VLevels.env3P, aes(x=Level, y=value, group = variable, color=variable))+
  geom_errorbar(aes(ymin=low, ymax=high), width=.1, position=position_dodge(.03)) +
  scale_colour_viridis_d(direction=-1)+
  geom_line(position=position_dodge(.03))+
  geom_point(position=position_dodge(.03))+
...
ggplot(permanova.seq10VLevels.env4P, aes(x=Level, y=value, group = variable, color=variable))+
  geom_errorbar(aes(ymin=low, ymax=high), width=.1, position=position_dodge(.03)) +
  scale_colour_viridis_d(direction=-1)+
  geom_line(position=position_dodge(.03))+
  geom_point(position=position_dodge(.03))+
...
ggplot(permanova.seq10VLevels.env5P, aes(x=Level, y=value, group = variable, color=variable))+
  geom_errorbar(aes(ymin=low, ymax=high), width=.1, position=position_dodge(.03)) +
  scale_colour_viridis_d(direction=-1)+
  geom_line(position=position_dodge(.03))+
  geom_point(position=position_dodge(.03))+
...
ggplot(permanova.seq10VLevels.residsP, aes(x=Level, y=value, group = variable, color=variable))+
  geom_errorbar(aes(ymin=low, ymax=high), width=.1, position=position_dodge(.03)) +
  scale_colour_viridis_d(direction=-1)+
  geom_line(position=position_dodge(.03))+
  geom_point(position=position_dodge(.03))+
...
method2<-c("model", "raw", "QSeq0.5", "QSeq10")
