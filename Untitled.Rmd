...
permanova.seq10Levels.modelP<-data_summary(permanova.seq10Levels.model, varname="value", groupnames=c("Level", "variable"))
permanova.seq10Levels.env1P<-data_summary(permanova.seq10Levels.env1, varname="value", groupnames=c("Level", "variable"))
permanova.seq10Levels.env2P<-data_summary(permanova.seq10Levels.env2, varname="value", groupnames=c("Level", "variable"))
permanova.seq10Levels.env3P<-data_summary(permanova.seq10Levels.env3, varname="value", groupnames=c("Level", "variable"))
permanova.seq10Levels.env4P<-data_summary(permanova.seq10Levels.env4, varname="value", groupnames=c("Level", "variable"))
permanova.seq10Levels.env5P<-data_summary(permanova.seq10Levels.env5, varname="value", groupnames=c("Level", "variable"))
permanova.seq10Levels.residsP<-data_summary(permanova.seq10Levels.resids, varname="value", groupnames=c("Level", "variable"))

permanova.seq10Levels.modelP2<-data_summary2(permanova.seq10Levels.model, varname="value", groupnames=c("Level", "variable"))
permanova.seq10Levels.env1P2<-data_summary2(permanova.seq10Levels.env1, varname="value", groupnames=c("Level", "variable"))
permanova.seq10Levels.env2P2<-data_summary2(permanova.seq10Levels.env2, varname="value", groupnames=c("Level", "variable"))
permanova.seq10Levels.env3P2<-data_summary2(permanova.seq10Levels.env3, varname="value", groupnames=c("Level", "variable"))
permanova.seq10Levels.env4P2<-data_summary2(permanova.seq10Levels.env4, varname="value", groupnames=c("Level", "variable"))
permanova.seq10Levels.env5P2<-data_summary2(permanova.seq10Levels.env5, varname="value", groupnames=c("Level", "variable"))
permanova.seq10Levels.residsP2<-data_summary2(permanova.seq10Levels.resids, varname="value", groupnames=c("Level", "variable"))
...
ggplot(permanova.seq10Levels.modelP, aes(x=Level, y=value, group = variable, color=variable))+
  ...
  geom_point(position=position_dodge(.3))+
  xlab("Sequencing Depth")+
  ylab("Permanova modelRatio (Median +/- sd)")+
  theme_classic()
...
ggplot(permanova.seq10Levels.residsP, aes(x=Level, y=value, group = variable, color=variable))+
  ...
  geom_point(position=position_dodge(.3))+
  xlab("Sequencing Depth")+
  ylab("Permanova residsRatio (Mean +/- sd)")+
  theme_classic()
...
permanova.seq10VLevels.modelP<-data_summary(permanova.seq10VLevels.model, varname="value", groupnames=c("Level", "variable"))
permanova.seq10VLevels.env1P<-data_summary(permanova.seq10VLevels.env1, varname="value", groupnames=c("Level", "variable"))
permanova.seq10VLevels.env2P<-data_summary(permanova.seq10VLevels.env2, varname="value", groupnames=c("Level", "variable"))
permanova.seq10VLevels.env3P<-data_summary(permanova.seq10VLevels.env3, varname="value", groupnames=c("Level", "variable"))
permanova.seq10VLevels.env4P<-data_summary(permanova.seq10VLevels.env4, varname="value", groupnames=c("Level", "variable"))
permanova.seq10VLevels.env5P<-data_summary(permanova.seq10VLevels.env5, varname="value", groupnames=c("Level", "variable"))

permanova.seq10VLevels.modelP2<-data_summary2(permanova.seq10VLevels.model, varname="value", groupnames=c("Level", "variable"))
permanova.seq10VLevels.env1P2<-data_summary2(permanova.seq10VLevels.env1, varname="value", groupnames=c("Level", "variable"))
permanova.seq10VLevels.env2P2<-data_summary2(permanova.seq10VLevels.env2, varname="value", groupnames=c("Level", "variable"))
permanova.seq10VLevels.env3P2<-data_summary2(permanova.seq10VLevels.env3, varname="value", groupnames=c("Level", "variable"))
permanova.seq10VLevels.env4P2<-data_summary2(permanova.seq10VLevels.env4, varname="value", groupnames=c("Level", "variable"))
permanova.seq10VLevels.env5P2<-data_summary2(permanova.seq10VLevels.env5, varname="value", groupnames=c("Level", "variable"))


ggplot(permanova.seq10VLevels.modelP, aes(x=Level, y=value, group = variable, color=variable))+
  geom_errorbar(aes(ymin=value-sd, ymax=value+sd), width=.1, position=position_dodge(.03)) +
  scale_colour_viridis_d(direction=-1)+
...
ggplot(permanova.seq10VLevels.modelP2, aes(x=Level, y=value, group = variable, color=variable))+
...
ggplot(permanova.seq10VLevels.env1P2, aes(x=Level, y=value, group = variable, color=variable))+
  geom_errorbar(aes(ymin=low, ymax=high), width=.1, position=position_dodge(.03)) +
  scale_colour_viridis_d(direction=-1)+
  geom_line(position=position_dodge(.03))+
  geom_point(position=position_dodge(.03))+
...
ggplot(permanova.seq10VLevels.env2P2, aes(x=Level, y=value, group = variable, color=variable))+
  geom_errorbar(aes(ymin=low, ymax=high), width=.1, position=position_dodge(.03)) +
  scale_colour_viridis_d(direction=-1)+
  geom_line(position=position_dodge(.03))+
  geom_point(position=position_dodge(.03))+
...
ggplot(permanova.seq10VLevels.env3P2, aes(x=Level, y=value, group = variable, color=variable))+
  geom_errorbar(aes(ymin=low, ymax=high), width=.1, position=position_dodge(.03)) +
  scale_colour_viridis_d(direction=-1)+
  geom_line(position=position_dodge(.03))+
  geom_point(position=position_dodge(.03))+
...
ggplot(permanova.seq10VLevels.env4P2, aes(x=Level, y=value, group = variable, color=variable))+
  geom_errorbar(aes(ymin=low, ymax=high), width=.1, position=position_dodge(.03)) +
  scale_colour_viridis_d(direction=-1)+
  geom_line(position=position_dodge(.03))+
  geom_point(position=position_dodge(.03))+
...
ggplot(permanova.seq10VLevels.env5P2, aes(x=Level, y=value, group = variable, color=variable))+
  geom_errorbar(aes(ymin=low, ymax=high), width=.1, position=position_dodge(.03)) +
  scale_colour_viridis_d(direction=-1)+
  geom_line(position=position_dodge(.03))+
  geom_point(position=position_dodge(.03))+
