...
run.analysis2<-function(commonN, groupN, singleN, D, V, method){
  ...
  #F5
      ...
      # create a tax table for whole dataset ...
          ...
          tab$value[tab$value==0]<-min(tab$value)/10 # 1 orders of magnitude lower than lowest; but not zero!!
...
#' Create network plot from networks that have been generated by BENCHMARK.MM
